...
const Navigation = () => {
    ...
    return (
        <>
            <div className="sticky top-0 px-3 py-3 md:px-5 md:py-5 w-full bg-gray-800 shadow-sm z-10">
                <div className="relative flex items-center justify-between mr-5 ml-2.5">
                    ...
                    <div className="lg:hidden z-10">
                        <button
                            ...
                            title="Open Menu"
                            className="p-2 text-gray-100 -mr-1 transition duration-200 rounded focus:outline-none focus:shadow-outline hover:bg-deep-purple-50 focus:bg-deep-purple-50"
